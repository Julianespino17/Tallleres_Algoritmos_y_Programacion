...
#salidas
print("El promedio de matematicas es de: ",prom_matematicas)
print("El promedio de fisica es de: ",prom_fisica)
print("El promedio de quimica es de: ",prom_quimica)
print("El promedio general de las tres materias es de: ",prom_general)